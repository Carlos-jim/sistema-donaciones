...
import { MapPin, Clock, PlusCircle, Calendar, Pill } from "lucide-react";
    ...
    async function fetchSolicitudes() {
      try {
        ...
        if (response.ok) {
          ...
          // Filter requests to show only those from the current user?
          // For now, assuming all returned requests are relevant or we show all in this demo context.
          // Ideally: data.filter(req => req.userId === currentUserId)
          setSolicitudes(data);
        }
      } catch (error) {
