...
export default function DonateMedicationClient({
  initialUserLocation,
}: {
  ...
  const [formData, setFormData] = useState<DonationFormData>({
    ...
    condition: "sealed",
    description: "",
    latitude: initialUserLocation?.lat || null,
    longitude: initialUserLocation?.lng || null,
  ...
  const nextStep = () => {
    if (currentStep < 3) {
      ...
      if (currentStep + 1 === 3) {
        ...
        setTimeout(() => setIsStep3Ready(true), 800); // 800ms safety delay
      }
    }
  };
                  ...
                  <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-500">
                        Confirma tu ubicación o selecciona una farmacia cercana
                        para la entrega.
                      </p>
                    </div>
                    <div className="space-y-2">
              ...
              <div className="px-8 py-5 bg-gray-50/80 border-t border-gray-100 flex justify-between items-center">
                ...
                {currentStep < 3 ? (
                  ...
                  <Button
                    key="submit-btn"
                    type="submit"
                    disabled={isLoading || !isStep3Ready}
                    className="bg-gradient-to-r from-teal-600 to-cyan-500 hover:from-teal-700 hover:to-cyan-600 text-white px-8 rounded-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
