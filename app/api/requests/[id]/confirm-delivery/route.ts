  ...
  try {
    ...
    await prisma.notificacion.create({
      data: {
        ...
        type: "SYSTEM",
        title: "El donante entregó en la farmacia",
        message: `El donante ha confirmado que entregó el medicamento en ${solicitud.farmaciaEntrega?.nombre}. La farmacia lo validará pronto. Código: ${solicitud.codigoComprobante || "N/A"}.`,
    ...
    return NextResponse.json({
      success: true,
      message: "Entrega confirmada. La farmacia validará el medicamento.",
    });
  } catch (error) {
